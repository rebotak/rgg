/* -----
	...
	{	
		...
		{
			this.font.draw (context, "SPIRITS", this.pos.x+x, this.pos.y+y);
	...
	{	
		...
		draw : function (context, x, y)
		{
			...
			context.strokeRect(this.pos.x+x, this.pos.y+y, 300, 8);
			if (hp>150) {
				// green
			...
			context.fillRect(this.pos.x+x+1, this.pos.y+y + 1, hp-1, 6);
		}
	});