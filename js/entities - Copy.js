...
var PlayerEntity = me.ObjectEntity.extend(
{
	...
	{
	//init the player entity, beserta dengan value awalnya
		this.q_spirit = 0;
		this.lastTime = new Date().getTime();
		this.animCorrent = "stand";
		this.spirit = false;
		settings.image = "galau";
	   ...
	   //set the animation frame from the galau image sprite
	...
	changeState : function(){
		if(!this.spirit){
			if(this.q_spirit >= 5){
				//berubah jadi semangat. sembunyiin layer fase awal
	...
	update : function (){
	// remove one life time point
			me.game.HUD.updateItemValue("life", -0.1);
			//standard value nya 0.1
			// game over ?
	...
	// end life time point
		...
		//jatuh ke jurang jika posisi Y dari player > dari 640.
		if (this.pos.y >= 640){
			//play audio
			me.audio.play("wee");
...
var EnemyEntity = me.ObjectEntity.extend({
	...
	onCollision : function (res, obj){
		...
		//give some score kalo musuh mati
		me.game.HUD.updateItemValue("score", 1);
		}
	},
